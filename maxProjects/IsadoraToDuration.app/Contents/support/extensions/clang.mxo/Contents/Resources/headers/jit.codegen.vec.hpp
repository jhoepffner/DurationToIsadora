...
public:
	...
	const Vec4 operator+ (Fixed v) const {
		return Vec4(x+v, y+v, z+v, w+v);
	}
	
	const Vec4 operator+ (long v) const {
		return Vec4(x+v, y+v, z+v, w+v);
	}
	
	const Vec4 operator+ (float v) const {
		return Vec4(x+v, y+v, z+v, w+v);
	}
	
	const Vec4 operator+ (double v) const {
		return Vec4(x+v, y+v, z+v, w+v);
	}
	...
	const Vec4 operator/ (float _v) const {
		float v = 1/_v;
		return Vec4(x*v, y*v, z*v, w*v);
	}
	
	const Vec4 operator/ (double _v) const {
		double v = 1/_v;
		return Vec4(x*v, y*v, z*v, w*v);
	}
...
/* Addition */
template <typename T>
const Vec4<T> operator+ (const Fixed s, const Vec4<T> &v) {
	return Vec4<T>(s+v.x, s+v.y, s+v.z, s+v.w);
}
template <typename T>
const Vec4<T> operator+ (const long s, const Vec4<T> &v) {
	return Vec4<T>(s+v.x, s+v.y, s+v.z, s+v.w);
}
template <typename T>
...
template <typename T>
const Vec4<T> operator+ (const double s, const Vec4<T> &v) {
	return Vec4<T>(s+v.x, s+v.y, s+v.z, s+v.w);
}
...
public:
	...
	const Vec3 operator+ (Fixed v) const {
		return Vec3(x+v, y+v, z+v);
	}
	
	const Vec3 operator+ (long v) const {
		return Vec3(x+v, y+v, z+v);
	}
	
	const Vec3 operator+ (float v) const {
		return Vec3(x+v, y+v, z+v);
	}
	
	const Vec3 operator+ (double v) const {
		return Vec3(x+v, y+v, z+v);
	}
	...
	const Vec3 operator/ (float _v) const {
		float v = 1/_v;
		return Vec3(x*v, y*v, z*v);
	}
	
	const Vec3 operator/ (double _v) const {
		double v = 1/_v;
		return Vec3(x*v, y*v, z*v);
	}
...
/* Addition */
template <typename T>
const Vec3<T> operator+ (const Fixed s, const Vec3<T> &v) {
	return Vec3<T>(s+v.x, s+v.y, s+v.z);
}
template <typename T>
const Vec3<T> operator+ (const long s, const Vec3<T> &v) {
	return Vec3<T>(s+v.x, s+v.y, s+v.z);
}
template <typename T>
...
template <typename T>
const Vec3<T> operator+ (const double s, const Vec3<T> &v) {
	return Vec3<T>(s+v.x, s+v.y, s+v.z);
}
...
public:
	...
	const Vec2 operator+ (Fixed v) const {
		return Vec2(x+v, y+v);
	}
	
	const Vec2 operator+ (long v) const {
		return Vec2(x+v, y+v);
	}
	...
	const Vec2 operator+ (double v) const {
		return Vec2(x+v, y+v);
	}
	...
	const Vec2 operator/ (float _v) const {
		float v = 1/_v;
		return Vec2(x*v, y*v);
	}
	
	const Vec2 operator/ (double _v) const {
		double v = 1/_v;
		return Vec2(x*v, y*v);
	}
...
/* Addition */
template <typename T>
const Vec2<T> operator+ (const Fixed s, const Vec2<T> &v) {
	return Vec2<T>(s+v.x, s+v.y);
}
template <typename T>
const Vec2<T> operator+ (const long s, const Vec2<T> &v) {
	return Vec2<T>(s+v.x, s+v.y);
}
template <typename T>
...
template <typename T>
const Vec2<T> operator+ (const double s, const Vec2<T> &v) {
	return Vec2<T>(s+v.x, s+v.y);
}
